...
return new class extends Migration {
    public function up(): void
    {
        ...
        $modules = [
            ...
            ['module_key' => 'vacations_balance',  'module_name' => 'الرصيد السنوي للإجازات',        'module_icon' => 'fas fa-umbrella-beach',     'sort_order' => 15],
            ['module_key' => 'tax',               'module_name' => 'الضرائب والفواتير الإلكترونية',  'module_icon' => 'fas fa-file-invoice-dollar','sort_order' => 16],
            ['module_key' => 'admin_permissions',  'module_name' => 'صلاحيات المستخدمين',            'module_icon' => 'fas fa-user-shield',        'sort_order' => 17],
        ];
        ...
        // ضمان أن admin ID=1 هو super admin دائماً
    ...
    {
        // لا نحذف البيانات عند الـ rollback لأن هذه بيانات أساسية
    }
};
