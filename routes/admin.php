...
Route::group(['prefix' => 'admin/dashboard'], function () {
    ...
    Route::get('/home', [AdminHomeController::class, 'index'])
        ->name('admin.dashboard.home.page')
        ->middleware('auth:admin');

    // =========================================================
    // الضبط العام — module: general_settings
    // =========================================================
    ...
    Route::get('branches/delete/{id}', [branchesController::class, 'delete'])
        ...
        ->middleware(['auth:admin', 'admin.permission:branches,can_delete']);

    // =========================================================
    // الشيفتات — module: shifts
    // =========================================================
    ...
    Route::get('shifts/delete/{id}', [Shifts_typeController::class, 'delete'])
        ->name('shifts.delete')
        ->middleware(['auth:admin', 'admin.permission:shifts,can_delete']);

    // =========================================================
    // الإدارات — module: departments
    // =========================================================
    ...
    Route::get('departs/delete/{id}', [DepartmentsController::class, 'delete'])
        ->name('departs.delete')
        ->middleware(['auth:admin', 'admin.permission:departments,can_delete']);

    // =========================================================
    // الوظائف — module: jobs_categories
    // =========================================================
    ...
    Route::get('jobs_categories/delete/{id}', [Jobs_categoriesController::class, 'delete'])
        ->name('jobs_categories.delete')
        ->middleware(['auth:admin', 'admin.permission:jobs_categories,can_delete']);
    Route::get('jobs_categores/delete/{id}', [Jobs_categoriesController::class, 'delete'])
        ->name('jobs_categores.delete')
        ->middleware(['auth:admin', 'admin.permission:jobs_categories,can_delete']);

    // =========================================================
    // الموظفون — module: employees
    // =========================================================
    ...
    Route::get('employees/delete/{id}', [EmployeesConroller::class, 'delete'])
        ...
        ->middleware(['auth:admin', 'admin.permission:employees,can_delete']);

    // =========================================================
    // السنوات المالية — module: finance_calender
    // =========================================================
    ...
    Route::get('finance_calender/delete/{id}', [Finance_calendersController::class, 'delete'])
        ->name('finance_calender.delete')
        ->middleware(['auth:admin', 'admin.permission:finance_calender,can_delete']);

    // =========================================================
    // الرصيد السنوي للإجازات — module: vacations_balance
    // =========================================================
    ...
    // =========================================================
    // الحضور والانصراف — module: attendance
    // =========================================================
    ...
    Route::get('attendance/delete/{id}', [AttendanceController::class, 'delete'])
        ...
        ->middleware(['auth:admin', 'admin.permission:attendance,can_delete']);

    // =========================================================
    // السلف — module: advances
    // =========================================================
    ...
    Route::get('advances/delete/{id}', [AdvancesController::class, 'delete'])
        ->name('advances.delete')
        ->middleware(['auth:admin', 'admin.permission:advances,can_delete']);

    // =========================================================
    // العمولات — module: commissions
    // =========================================================
    ...
    Route::get('commissions/delete/{id}', [CommissionsController::class, 'delete'])
        ...
        ->middleware(['auth:admin', 'admin.permission:commissions,can_delete']);

    // =========================================================
    // الخصومات — module: deductions
    // =========================================================
    ...
    Route::get('deductions/delete/{id}', [DeductionsController::class, 'delete'])
        ...
        ->middleware(['auth:admin', 'admin.permission:deductions,can_delete']);

    // =========================================================
    // مسير الرواتب — module: payroll
    // =========================================================
    ...
    Route::get('payroll/approve/{id}', [PayrollController::class, 'approve'])
        ...
        ->middleware(['auth:admin', 'admin.permission:payroll,can_update']);
    Route::get('payroll/delete/{id}', [PayrollController::class, 'delete'])
        ->name('payroll.delete')
        ->middleware(['auth:admin', 'admin.permission:payroll,can_delete']);

    // =========================================================
    // صلاحيات المستخدمين — سوبر أدمن فقط (الـ middleware
    // الداخلي في الـ Controller يتحقق من is_super_admin)
    // =========================================================
