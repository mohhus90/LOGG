...
use App\Http\Controllers\Admin\HR\LeaveCompensationController;
...
class AttendanceController extends Controller
{
    ...
    {
        return $this->calc->resolveRates($employee, $settings, $date);
    }
    ...
    {
        return $this->calc->resolveOvertimeMultiplier($employee, $settings);
    }
    ...
    {
        return $this->calc->buildCalcParams($employee, $settings, $date);
    }
    ...
    {
        $this->calc->apply($attendance, $employee, $settings, $date);
    }
