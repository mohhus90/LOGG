...
@section('title') سندات الصرف @endsection
...
<div class="col-12">
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-money-check ml-2"></i> سندات الصرف</h3>
            <div class="card-tools">
                <a href="{{ route('treasury_payments.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> سند صرف جديد</a>
            </div>
        </div>
            ...
            <table class="table table-bordered table-hover table-striped mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('treasury_payments.show', $voucher->id) }}" class="btn btn-xs btn-info"><i class="fas fa-eye"></i></a></td>
                    </tr>
                    @empty
                    <tr><td colspan="7" class="text-center py-4 text-muted">لا توجد سندات صرف</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
