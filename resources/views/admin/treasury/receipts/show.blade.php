...
<div class="col-lg-8">
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-hand-holding-usd ml-2"></i> سند قبض {{ $voucher->voucher_number }}</h3>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 mt-2"><strong>الوارد من:</strong> {{ $voucher->party_name }}</div>
            ...
            @if($voucher->cheque)
            <hr>
            <p><strong>بيانات الشيك:</strong> رقم {{ $voucher->cheque->cheque_number }} - {{ $voucher->cheque->bank_name }} -
