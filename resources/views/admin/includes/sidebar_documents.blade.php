<div class="sidebar">
    ...
    <div class="info w-100">
      <div class="d-flex align-items-center justify-content-between">
        <span class="text-white font-weight-bold" style="font-size:.95rem">
          <i class="fas fa-file-alt ml-1" style="color:#facc15"></i>
          موديول إدارة الوثائق
        </span>
  ...
  <nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column nav-sidebar-rtl"
      ...
      <li class="nav-item">
        <a href="{{ route('document_categories.index') }}"
           class="nav-link {{ request()->routeIs('document_categories.*') ? 'active' : '' }}">
