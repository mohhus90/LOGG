...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-body">
              <form method="POST" action="{{ route('jobs_categores.store') }}">
                @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-5">
                      <input type="time" class="form-control" name="from_time" id="from_time" value="{{ old('from_time') }}" oninput="calculateTotalHour()">
                  </div>
                  @error('from_time')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-5">
                      <input type="time" class="form-control" name="to_time" id="to_time" value="{{ old('to_time') }}" oninput="calculateTotalHour()">
                  </div>
                  @error('to_time')
                  <span class="text-danger text-center ">{{ $message }}</span>
                  @enderror
                ...
                <div class="text-center">
                  ...
                  <a class="btn btn-warning btn-lg col-2" href="{{ route('jobs_categores.index') }}">الغاء</a>
                </div>
