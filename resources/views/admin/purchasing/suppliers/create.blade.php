...
@section('title') إضافة مورد @endsection
...
<div class="col-md-10 mx-auto">
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-truck-loading ml-2"></i>إضافة مورد جديد
            </h3>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 form-group">
                                ...
                                <input type="text" name="code" class="form-control"
                                    placeholder="كود المورد" value="{{ old('code') }}">
                            </div>
                            <div class="col-md-5 form-group">
                                <label>الاسم بالعربية <span class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control" required
                                    placeholder="اسم المورد" value="{{ old('name') }}">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>الاسم بالإنجليزية</label>
                                <input type="text" name="name_en" class="form-control"
                                    placeholder="Supplier name in English" value="{{ old('name_en') }}">
                            </div>
                        </div>
