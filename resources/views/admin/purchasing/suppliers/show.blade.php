...
@section('title') بيانات المورد @endsection
...
<div class="col-12">
    ...
    <div class="mb-3 d-flex flex-wrap">
        <a href="{{ route('suppliers.edit', $supplier->id) }}" class="btn btn-warning ml-2 mb-1">
            <i class="fas fa-edit ml-1"></i> تعديل البيانات
        </a>
        <a href="{{ route('purchase_invoices.create', ['supplier_id' => $supplier->id]) }}" class="btn btn-success ml-2 mb-1">
            <i class="fas fa-file-invoice ml-1"></i> إضافة فاتورة
        </a>
        <a href="{{ route('purchase_payments.create', ['supplier_id' => $supplier->id]) }}" class="btn btn-primary ml-2 mb-1">
            <i class="fas fa-hand-holding-usd ml-1"></i> تسجيل دفعة
        </a>
        <a href="{{ route('suppliers.index') }}" class="btn btn-secondary mb-1">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-4">
            <div class="info-box stat-card {{ ($totalDebt ?? 0) > 0 ? 'bg-danger' : 'bg-secondary' }}">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">صافي المستحقات</span>
            ...
            <div class="card card-outline card-primary">
                <div class="card-header py-2">
                    <h6 class="card-title mb-0">
                        <i class="fas fa-truck ml-1"></i> بيانات المورد
                ...
                <div class="card-body py-2">
                    <div class="detail-row">
                        ...
                        <span class="detail-value"><code>{{ $supplier->code ?? '—' }}</code></span>
                    </div>
                    <div class="detail-row">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">{{ $supplier->name_en }}</span>
                    </div>
                    @endif
                    <div class="detail-row">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">{{ $supplier->phone2 }}</span>
                    </div>
                    @endif
                    @if($supplier->email)
                    <div class="detail-row">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">{{ $supplier->address }}{{ $supplier->city ? ' — ' . $supplier->city : '' }}{{ $supplier->governorate ? ' — ' . $supplier->governorate : '' }}</span>
                    </div>
                    @endif
                    @if($supplier->tax_number)
                    <div class="detail-row">
                        <span class="detail-label">الرقم الضريبي</span>
                        <span class="detail-value">{{ $supplier->tax_number }}</span>
                    </div>
                    @endif
                    @if($supplier->commercial_register)
                    <div class="detail-row">
                        <span class="detail-label">السجل التجاري</span>
                        <span class="detail-value">{{ $supplier->commercial_register }}</span>
                    </div>
                    @endif
                    <div class="detail-row">
                        <span class="detail-label">شروط الدفع</span>
                        <span class="detail-value">{{ $supplier->payment_terms ?? 0 }} يوم</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">الرصيد الافتتاحي</span>
                        <span class="detail-value">{{ number_format($supplier->opening_balance ?? 0, 2) }} ج.م</span>
                    </div>
                    <div class="detail-row">
                    ...
                    <div class="mt-2 p-2 bg-light rounded">
                        <small class="text-muted"><i class="fas fa-sticky-note ml-1"></i> {{ $supplier->notes }}</small>
                    </div>
                    @endif
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('purchase_invoices.show', $inv->id) }}">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered mb-0">
                            ...
                            <tbody>
                                @forelse($supplier->payments as $pay)
                                <tr>
