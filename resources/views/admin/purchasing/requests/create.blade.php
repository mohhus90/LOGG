...
@section('title') طلب شراء جديد @endsection
...
@section('content')
<div class="col-12">
    <form action="{{ route('purchase_requests.store') }}" method="POST" id="requestForm">
        @csrf

        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-clipboard-list ml-2"></i> إضافة طلب شراء جديد</h3>
            </div>
            <div class="card-body">
                @if($errors->any())
        ...
        <div class="card-footer bg-white border-top-0 px-0">
            ...
            <a href="{{ route('purchase_requests.index') }}" class="btn btn-secondary mr-2">
