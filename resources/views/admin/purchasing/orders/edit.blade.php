...
@section('title') تعديل أمر شراء @endsection
...
@section('content')
<div class="col-12">
    <form action="{{ route('purchase_orders.update', $order->id) }}" method="POST" id="orderForm">
        @csrf

        <div class="card card-warning card-outline">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-edit ml-2"></i> تعديل أمر الشراء رقم: <strong>{{ $order->order_number }}</strong></h3>
            </div>
            <div class="card-body">
                @if($errors->any())
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" name="expected_date" class="form-control"
                                   value="{{ old('expected_date', optional($order->expected_date)->format('Y-m-d')) }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
        ...
        <div class="card-footer bg-white border-top-0 px-0">
            ...
            <a href="{{ route('purchase_orders.show', $order->id) }}" class="btn btn-secondary mr-2">
