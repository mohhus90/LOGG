...
@section('title') إضافة فاتورة شراء @endsection
...
@section('content')
<div class="col-12">
    <form action="{{ route('purchase_invoices.store') }}" method="POST" id="invoiceForm">
        @csrf

        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-file-invoice-dollar ml-2"></i> إضافة فاتورة شراء جديدة</h3>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="invoice_type" class="form-control">
                                <option value="cash"   {{ old('invoice_type') == 'cash'   ? 'selected' : '' }}>نقدي</option>
                                <option value="credit" {{ old('invoice_type', 'credit') == 'credit' ? 'selected' : '' }}>آجل</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-5">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="supplier_invoice_no" class="form-control" value="{{ old('supplier_invoice_no') }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>نسبة الضريبة %</label>
                            <input type="number" name="tax_rate" id="taxRate" class="form-control" value="{{ old('tax_rate', 14) }}" min="0" max="100" step="0.01">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>المخزن (استلام البضاعة)</label>
        ...
        <div class="card-footer bg-white border-top-0 px-0">
            ...
            <a href="{{ route('purchase_invoices.index') }}" class="btn btn-secondary mr-2">
