...
@section('title') إضافة عمولة @endsection
...
<div class="col-md-7 mx-auto">
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-plus-circle ml-2"></i>إضافة عمولة جديدة</h3>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label>تاريخ العمولة <span class="text-danger">*</span></label>
                        <input type="date" name="commission_date" class="form-control" required
                            value="{{ old('commission_date', today()->format('Y-m-d')) }}">
                    </div>
                    <div class="col-md-6 form-group">
                        <label>نوع العمولة</label>
                        <input type="text" name="commission_type" class="form-control"
                            placeholder="مثال: عمولة مبيعات، بدل إنتاج..."
                            value="{{ old('commission_type') }}">
                    </div>
                </div>
