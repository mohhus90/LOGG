...
<div class="col-md-10 mx-auto">
    <div class="card card-warning">
        ...
        <form action="{{ route('sales_customers.update', $customer->id) }}" method="POST">
            @csrf
            <div class="card-body">
                @if($errors->any())
                        ...
                        <div class="row">
                            <div class="col-md-3 form-group">
                                ...
                                <input type="text" name="code" class="form-control"
                                    placeholder="كود العميل" value="{{ old('code', $customer->code) }}">
                            </div>
                            <div class="col-md-5 form-group">
                                <label>الاسم بالعربية <span class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control" required
                                    placeholder="اسم العميل" value="{{ old('name', $customer->name) }}">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>الاسم بالإنجليزية</label>
                                <input type="text" name="name_en" class="form-control"
                                    placeholder="Customer name in English" value="{{ old('name_en', $customer->name_en) }}">
                            </div>
                        </div>
                            ...
                            <div class="d-flex mt-1">
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="type_individual" name="type" value="individual"
                                        class="custom-control-input"
                                        {{ old('type', $customer->type) == 'individual' ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" name="phone" class="form-control"
                                    placeholder="رقم الهاتف" value="{{ old('phone', $customer->phone) }}">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>هاتف بديل</label>
                                <input type="text" name="phone2" class="form-control"
                                    placeholder="رقم هاتف بديل" value="{{ old('phone2', $customer->phone2) }}">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>البريد الإلكتروني</label>
                                <input type="email" name="email" class="form-control"
                                    placeholder="example@mail.com" value="{{ old('email', $customer->email) }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="address" class="form-control"
                                    placeholder="العنوان التفصيلي" value="{{ old('address', $customer->address) }}">
                            </div>
                            <div class="col-md-3 form-group">
                                <label>المدينة</label>
                                <input type="text" name="city" class="form-control"
                                    placeholder="المدينة" value="{{ old('city', $customer->city) }}">
                            </div>
                            <div class="col-md-3 form-group">
                                <label>المحافظة</label>
                                <input type="text" name="governorate" class="form-control"
                                    placeholder="المحافظة" value="{{ old('governorate', $customer->governorate) }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="tax_number" class="form-control"
                                    placeholder="الرقم الضريبي" value="{{ old('tax_number', $customer->tax_number) }}">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>السجل التجاري</label>
                                <input type="text" name="commercial_register" class="form-control"
                                    placeholder="رقم السجل التجاري" value="{{ old('commercial_register', $customer->commercial_register) }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea name="notes" class="form-control" rows="3"
                                placeholder="أي ملاحظات إضافية...">{{ old('notes', $customer->notes) }}</textarea>
                        </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('sales_customers.show', $customer->id) }}" class="btn btn-info mr-2">
