...
<div class="col-12">
    <div class="card card-danger card-outline">
        ...
        <form method="POST" action="{{ route('sales_returns.store') }}" id="returnForm">
            @csrf
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>المخزن (لاستلام المرتجع)</label>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('sales_returns.index') }}" class="btn btn-secondary mr-2">
...
$(document).ready(function() {
    ...
    $('#customer_id').on('change', function() {
        ...
        $.get('/admin/dashboard/sales/customers/' + customerId + '/invoices', function(data) {
