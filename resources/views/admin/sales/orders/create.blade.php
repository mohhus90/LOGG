...
@section('title') إضافة أمر بيع @endsection
...
@section('content')
<div class="col-12">
    <form action="{{ route('sales_orders.store') }}" method="POST" id="orderForm">
        @csrf

        {{-- Header Card --}}
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-shopping-cart ml-2"></i> إضافة أمر بيع جديد</h3>
            </div>
            <div class="card-body">
                @if($errors->any())
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                                ...
                                <option value="processing" {{ old('status') == 'processing' ? 'selected' : '' }}>قيد التنفيذ</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="delivery_address" class="form-control" rows="2"
                                      placeholder="عنوان تسليم البضاعة...">{{ old('delivery_address') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="form-group mb-0">
                            ...
                            <textarea name="notes" class="form-control" rows="4"
                                      placeholder="أي ملاحظات خاصة بأمر البيع...">{{ old('notes') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card-footer bg-white border-top-0 px-0">
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-save ml-1"></i> حفظ أمر البيع
            </button>
            <a href="{{ route('sales_orders.index') }}" class="btn btn-secondary mr-2">
