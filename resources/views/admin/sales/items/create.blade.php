...
@section('title') إضافة صنف @endsection
...
<div class="col-md-9 mx-auto">
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-plus-circle ml-2"></i>إضافة صنف جديد
            </h3>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 form-group">
                                ...
                                <input type="text" name="code" class="form-control"
                                    placeholder="كود الصنف" value="{{ old('code') }}">
                            </div>
                            <div class="col-md-3 form-group">
                                <label>الباركود</label>
                                <input type="text" name="barcode" class="form-control"
                                    placeholder="باركود" value="{{ old('barcode') }}">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>الاسم بالعربية <span class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control" required
                                    placeholder="اسم الصنف" value="{{ old('name') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="name_en" class="form-control"
                                    placeholder="Item name in English" value="{{ old('name_en') }}">
                            </div>
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="external_sku" class="form-control"
                                    ...
                                    value="{{ old('external_sku') }}">
                            </div>
                            <div class="col-md-3 form-group">
                                <label>النوع</label>
                                <select name="type" class="form-control">
                                    <option value="product"       {{ old('type','product') == 'product'       ? 'selected' : '' }}>منتج</option>
                                    <option value="service"       {{ old('type') == 'service'       ? 'selected' : '' }}>خدمة</option>
                                    <option value="raw_material"  {{ old('type') == 'raw_material'  ? 'selected' : '' }}>مادة خام</option>
                                    <option value="semi_finished" {{ old('type') == 'semi_finished' ? 'selected' : '' }}>نصف مصنّع</option>
                                </select>
                            </div>
                            <div class="col-md-3 form-group">
                                <label>الحالة</label>
...
@section('script')
<script>
// عرض اسم الملف المختار في custom-file-input
