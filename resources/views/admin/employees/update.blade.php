                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        ...
                                        <input type="text" class="form-control" name="medical_id" id="medical_id" value="{{ old('medical_id', $data['medical_id']) }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="">
                                        ...
                                        <select class="form-control" name="medical_status" id="medical_status">
                                            ...
                                            <option value="Active"      {{ old('medical_status', $data['medical_status']) == 'Active'      ? 'selected' : '' }}>Active</option>
                                            <option value="Resigned"    {{ old('medical_status', $data['medical_status']) == 'Resigned'    ? 'selected' : '' }}>Resigned</option>
                                            <option value="Cancelled"   {{ old('medical_status', $data['medical_status']) == 'Cancelled'   ? 'selected' : '' }}>Cancelled</option>
                                            <option value="Terminated"  {{ old('medical_status', $data['medical_status']) == 'Terminated'  ? 'selected' : '' }}>Terminated</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="">
                                        ...
                                        <select class="form-control" name="medical_progress" id="medical_progress">
                                            <option value="">— اختر —</option>
                                            <option value="Completed"   {{ old('medical_progress', $data['medical_progress']) == 'Completed'   ? 'selected' : '' }}>Completed</option>
                                            <option value="Not Started" {{ old('medical_progress', $data['medical_progress']) == 'Not Started' ? 'selected' : '' }}>Not Started</option>
                                            <option value="In Progress" {{ old('medical_progress', $data['medical_progress']) == 'In Progress' ? 'selected' : '' }}>In Progress</option>
                                            <option value="In process"  {{ old('medical_progress', $data['medical_progress']) == 'In process'  ? 'selected' : '' }}>In process</option>
                                            <option value="Cancelled"   {{ old('medical_progress', $data['medical_progress']) == 'Cancelled'   ? 'selected' : '' }}>Cancelled</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
