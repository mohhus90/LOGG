...
<head>
  ...
  <title>@yield('title') — عملاء NEXA</title>
  ...
  <style>
    /* CRM module accent color — teal */
    .main-sidebar { background: #1a1f2e !important; }
    .main-sidebar .brand-link { border-bottom: 1px solid rgba(45,212,191,.2) !important; }
    .sidebar-dark-primary .nav-sidebar > .nav-item > .nav-link.active,
    .sidebar-dark-primary .nav-sidebar > .nav-item > .nav-link:hover {
      background-color: rgba(45,212,191,.15) !important;
      color: #2dd4bf !important;
    }
    .brand-link .brand-text { color: #2dd4bf !important; }
    .module-tag {
    ...
    .kanban-col { background: #f8f9fa; border-radius: 6px; padding: 10px; min-height: 200px; }
    .kanban-card { background: #fff; border: 1px solid #dee2e6; border-radius: 6px; padding: 10px; margin-bottom: 8px; }
  </style>
...
<div class="wrapper">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <span class="navbar-text">
          <span class="module-tag">
            <i class="fas fa-handshake ml-1" style="font-size:.65rem"></i>إدارة علاقات العملاء
          </span>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right">
          ...
          <a class="dropdown-item text-danger" href="#"
             onclick="event.preventDefault(); document.getElementById('logout-form-crm').submit();">
            <i class="fas fa-sign-out-alt ml-2"></i> تسجيل الخروج
          </a>
          <form id="logout-form-crm" action="{{ route('admin.dashboard.logout') }}" method="POST" style="display:none">
            @csrf
          </form>
        </div>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="{{ route('crm_leads.index') }}" class="brand-link">
      @php
      ...
      @endif
      <span class="brand-text font-weight-bold" style="color:#2dd4bf">
        {{ $__setting->com_name ?? 'NEXA' }}
        <small style="color:#6b7280;font-size:.65rem;display:block;font-weight:400;margin-top:-3px">CRM Module</small>
      </span>
    </a>
    @include('admin.includes.sidebar_crm')
  </aside>
