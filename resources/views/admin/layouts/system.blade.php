...
<head>
  ...
  <title>@yield('title') — النظام NEXA</title>
  ...
  <style>
    /* System module accent color — slate */
    .main-sidebar { background: #1a1f2e !important; }
    .main-sidebar .brand-link { border-bottom: 1px solid rgba(148,163,184,.2) !important; }
    .sidebar-dark-primary .nav-sidebar > .nav-item > .nav-link.active,
    .sidebar-dark-primary .nav-sidebar > .nav-item > .nav-link:hover {
      background-color: rgba(148,163,184,.15) !important;
      color: #94a3b8 !important;
    }
    .brand-link .brand-text { color: #94a3b8 !important; }
    .module-tag {
...
<div class="wrapper">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <span class="navbar-text">
          <span class="module-tag">
            <i class="fas fa-building ml-1" style="font-size:.65rem"></i>النظام
          </span>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right">
          <a class="dropdown-item" href="{{ route('company_profile.edit') }}">
            <i class="fas fa-building ml-2"></i> بيانات شركتي
          </a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item text-danger" href="#"
             onclick="event.preventDefault(); document.getElementById('logout-form-system').submit();">
            <i class="fas fa-sign-out-alt ml-2"></i> تسجيل الخروج
          </a>
          <form id="logout-form-system" action="{{ route('admin.dashboard.logout') }}" method="POST" style="display:none">
            @csrf
          </form>
        </div>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="{{ route('company_profile.edit') }}" class="brand-link">
      @php
      ...
      @endif
      <span class="brand-text font-weight-bold" style="color:#94a3b8">
        {{ $__setting->com_name ?? 'NEXA' }}
        <small style="color:#6b7280;font-size:.65rem;display:block;font-weight:400;margin-top:-3px">System Module</small>
      </span>
    </a>
    @include('admin.includes.sidebar_system')
  </aside>
