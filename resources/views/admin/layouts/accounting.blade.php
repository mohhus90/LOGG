...
<head>
  ...
  <title>@yield('title') — محاسبة NEXA</title>
  ...
  <style>
    /* Accounting module accent color — violet */
    .main-sidebar { background: #1a1f2e !important; }
    .main-sidebar .brand-link { border-bottom: 1px solid rgba(167,139,250,.2) !important; }
    .sidebar-dark-primary .nav-sidebar > .nav-item > .nav-link.active,
    .sidebar-dark-primary .nav-sidebar > .nav-item > .nav-link:hover {
      background-color: rgba(167,139,250,.15) !important;
      color: #a78bfa !important;
    }
    .brand-link .brand-text { color: #a78bfa !important; }
    .module-tag {
...
<div class="wrapper">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <span class="navbar-text">
          <span class="module-tag">
            <i class="fas fa-calculator ml-1" style="font-size:.65rem"></i>المحاسبة
          </span>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right">
          ...
          <form id="logout-form-accounting" action="{{ route('admin.dashboard.logout') }}" method="POST" style="display:none">
            @csrf
          </form>
        </div>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="{{ route('accounting_reports.index') }}" class="brand-link">
      @php
      ...
      @endif
      <span class="brand-text font-weight-bold" style="color:#a78bfa">
        {{ $__setting->com_name ?? 'NEXA' }}
        <small style="color:#6b7280;font-size:.65rem;display:block;font-weight:400;margin-top:-3px">Accounting Module</small>
      </span>
    </a>
    @include('admin.includes.sidebar_accounting')
  </aside>
