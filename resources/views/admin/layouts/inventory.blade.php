...
<head>
  ...
  <title>@yield('title') — مخازن NEXA</title>
  ...
  <style>
    /* Inventory module accent color — amber/orange */
    .main-sidebar { background: #1a1f2e !important; }
    .main-sidebar .brand-link { border-bottom: 1px solid rgba(245,158,11,.2) !important; }
    .sidebar-dark-primary .nav-sidebar > .nav-item > .nav-link.active,
    .sidebar-dark-primary .nav-sidebar > .nav-item > .nav-link:hover {
      background-color: rgba(245,158,11,.15) !important;
      color: #fbbf24 !important;
    }
    .brand-link .brand-text { color: #fbbf24 !important; }
    .module-tag {
...
<div class="wrapper">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <span class="navbar-text">
          <span class="module-tag">
            <i class="fas fa-warehouse ml-1" style="font-size:.65rem"></i>المخازن
          </span>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right">
          ...
          <a class="dropdown-item text-danger" href="#"
             onclick="event.preventDefault(); document.getElementById('logout-form-inventory').submit();">
            <i class="fas fa-sign-out-alt ml-2"></i> تسجيل الخروج
          </a>
          <form id="logout-form-inventory" action="{{ route('admin.dashboard.logout') }}" method="POST" style="display:none">
            @csrf
          </form>
        </div>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="{{ route('inventory_reports.index') }}" class="brand-link">
      @php
      ...
      @endif
      <span class="brand-text font-weight-bold" style="color:#fbbf24">
        {{ $__setting->com_name ?? 'NEXA' }}
        <small style="color:#6b7280;font-size:.65rem;display:block;font-weight:400;margin-top:-3px">Inventory Module</small>
      </span>
    </a>
    @include('admin.includes.sidebar_inventory')
  </aside>
