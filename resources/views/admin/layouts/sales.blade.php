...
<head>
  ...
  <title>@yield('title') — مبيعات NEXA</title>
  ...
  <style>
    /* Sales module accent color — green */
    .main-sidebar { background: #1a1f2e !important; }
    .main-sidebar .brand-link { border-bottom: 1px solid rgba(52,211,153,.2) !important; }
    .sidebar-dark-primary .nav-sidebar > .nav-item > .nav-link.active,
    .sidebar-dark-primary .nav-sidebar > .nav-item > .nav-link:hover {
      background-color: rgba(52,211,153,.15) !important;
      color: #34d399 !important;
    }
    .brand-link .brand-text { color: #34d399 !important; }
    .module-tag {
...
<div class="wrapper">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <span class="navbar-text">
          <span class="module-tag">
            <i class="fas fa-chart-line ml-1" style="font-size:.65rem"></i>المبيعات
          </span>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right">
          ...
          <a class="dropdown-item text-danger" href="#"
             onclick="event.preventDefault(); document.getElementById('logout-form-sales').submit();">
            <i class="fas fa-sign-out-alt ml-2"></i> تسجيل الخروج
          </a>
          <form id="logout-form-sales" action="{{ route('admin.dashboard.logout') }}" method="POST" style="display:none">
            @csrf
          </form>
        </div>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="{{ route('sales_reports.index') }}" class="brand-link">
      @php
      ...
      @endif
      <span class="brand-text font-weight-bold" style="color:#34d399">
        {{ $__setting->com_name ?? 'NEXA' }}
        <small style="color:#6b7280;font-size:.65rem;display:block;font-weight:400;margin-top:-3px">Sales Module</small>
      </span>
    </a>
    @include('admin.includes.sidebar_sales')
  </aside>
