...
<head>
    ...
    <title>NEXA ERP — نظام تخطيط الموارد المؤسسية</title>
    ...
    <div class="container">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center gap-3">
                <a href="{{ route('admin.dashboard.login') }}" class="nav-login-btn">
...
<section class="hero">
    <div class="hero-badge">
        <span class="dot"></span>
        النظام جاهز للاستخدام — الموارد البشرية والمبيعات مفعّلان بالكامل
    </div>
    <h1>
        نظام <span class="gradient-text">NEXA ERP</span><br>
        المتكامل للشركات والمصانع
    </h1>
    <p>
        منظومة متكاملة لإدارة جميع موارد مؤسستك — من الموارد البشرية والرواتب
        إلى المبيعات والمحاسبة والإنتاج، كل ذلك من منصة واحدة بالكامل بالعربية.
    </p>
    <a href="{{ route('admin.dashboard.login') }}" class="nav-login-btn" style="font-size:16px; padding:12px 32px;">
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 reveal">
                <a href="{{ route('admin.dashboard.login') }}" class="module-card active-module mod-hr">
            ...
            {{-- 2. Sales --}}
            <div class="col-xl-3 col-lg-4 col-md-6 reveal">
                <a href="{{ route('admin.dashboard.login') }}" class="module-card active-module mod-sales">
            ...
            {{-- 4. Inventory --}}
            <div class="col-xl-3 col-lg-4 col-md-6 reveal">
                <div class="module-card coming-soon mod-inv">
                    ...
                    <div class="module-features">
                        <span class="feature-tag">الأصناف</span>
                        <span class="feature-tag">حركة المخزون</span>
                        <span class="feature-tag">الجرد</span>
            ...
            {{-- 7. Purchasing --}}
            <div class="col-xl-3 col-lg-4 col-md-6 reveal">
                <div class="module-card coming-soon mod-purch">
                    ...
                    <div class="module-features">
                        ...
                        <span class="feature-tag">عروض الأسعار</span>
                        <span class="feature-tag">الاستلام</span>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 mx-auto">
                ...
                <div class="reveal">
                    ...
                    <div class="roadmap-item">
                        <div class="roadmap-num rm-next">3</div>
                        <div class="roadmap-info">
                            <h5>المرحلة الثالثة — المشتريات والمخازن</h5>
                            <p>طلبات الشراء • الموردون • أوامر الشراء • إدارة المخزون</p>
                        </div>
                        <span class="roadmap-status rs-next">التالية</span>
                    </div>

                    <div class="roadmap-item">
                        <div class="roadmap-num rm-plan">3</div>
                        <div class="roadmap-info">
                            <h5>المرحلة الثالثة — المخازن والحسابات</h5>
                            <p>المخزون • حركة الأصناف • دليل الحسابات • القيود اليومية</p>
                        </div>
                        <span class="roadmap-status rs-plan">مخطط</span>
                    </div>

                    <div class="roadmap-item">
                        <div class="roadmap-num rm-plan">4</div>
                        <div class="roadmap-info">
                            <h5>المرحلة الرابعة — الإنتاج والجودة</h5>
                    ...
                    <div class="roadmap-item">
                        <div class="roadmap-num rm-plan">5</div>
                        <div class="roadmap-info">
                            <h5>المرحلة الخامسة — CRM والتقارير المتقدمة</h5>
